...
import 'package:task/core/helpers/language_helper.dart';
...
import 'package:task/core/cache/cache_manager.dart';
    ...
    if (err.response?.statusCode == 401) {
      ...
      if (refreshSuccess) {
        ...
        if (cachedToken.isEmpty) {
          ...
          log('âš ï¸ Skipping token clear on 401 - user is in verify OTP process');
        }
      }
    }
